...
public interface TransactionRepository extends JpaRepository<Transaction, Long>, BackOfficeCustomQuery, RiskParametersCustomQuery, JpaSpecificationExecutor<Transaction> {
