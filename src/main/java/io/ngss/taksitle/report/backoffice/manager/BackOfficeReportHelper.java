package io.ngss.taksitle.report.backoffice.manager;
...
@Component
public class BackOfficeReportHelper {
        ...
        groupedByCustomer.forEach((customer, transactionList) -> {
            ...
            if (requiredPreviousStateForCancellations) {
                cancelTransactionss.forEach(x -> {
                    ...
                    TransactionState previousState = historyLogs.get(1).getTransactionState();
