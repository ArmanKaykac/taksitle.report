package io.ngss.taksitle.report.bank.ononay.repository;
...
public interface PreApplicationRequestRepository extends JpaRepository<PreApplicationRequest, Long> {
